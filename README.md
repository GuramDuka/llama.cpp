...
- **Comprehensive Test Suite** — 23 Python integration tests (non-router + router mode) and 22 C++ tests covering combined 3-tier pool sorting, disk persistence, LCP comparison, TTL eviction, trie rebuild, zstd compression round-trips, dictionary learning (all 4 levels), multi-model smoke tests, cross-model cache isolation, and MTP L3 cache determinism. Registered as ctest targets.
